...
public class CommandHandler {
    ...
    private void showPresentList(){
        ArrayList<Student> list = attendance.getPresentStudents();
        for (Student student:
                list) {
            System.out.println("student name : " + student.getStudentID().getFirstName() + student.getStudentID().getLastName() +
                    " | id : " + student.getStudentID().getId());
    ...
    private void addNewStudent(Boolean presence, String sid){
        System.out.println("Please Enter the information of student in this format : <first_name> <last_name> <social_id> <chair_number>");
        ...
        String ssn = commandParts[2];
        int chairNumber = Integer.valueOf(commandParts[3]);
    ...
    private void attendStudent(){
        ...
        try {
            ...
            System.out.println("The studentID you entered does not exist.\n" +
                    "If you want to add this student to list enter '1' otherwise enter '0'.");
            ...
            switch (inputCommandInt){
                case 1:
                    addNewStudent(presence, studentID);
                case 0:
                    break;
                default:
                    System.out.println("The command you entered is not valid.");
    ...
    private void attendanceHandler(){
        System.out.println("Please enter one of the following command according your desired order\n" +
                ...
                "2 : Terminate the attendance\n" +
                "3 : Show absent Students list"
//                + "\n4: Show present Students list"
                );
        int inputCommand = -1;
        try {
            inputCommand = Integer.valueOf(in.nextLine());
